package com.kaveingas.incomemanager;
...
public class IncomemanagerApplication {

	public static void main(String[] args) {
		TimeZone.setDefault(TimeZone.getTimeZone("UTC"));
		SpringApplication.run(IncomemanagerApplication.class, args);
	}
	...
	public CommandLineRunner commandLineRunner(ApplicationContext ctx) {
		return args -> {
			...
			try {
				...
				System.out.println("************************ Income Manager - API ***************************");
